...
% INPUT:    Model data structure (generated by getECnumbers.m)
 ...
 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 function kcats = matchKcatsiBag(model_data, org_name)
 %Load BRENDA data:
 [KCATcell, SAcell] = loadBRENDAdataiBag;
...
%      end        
 ...
 function phylDistStruct =  KEGG_struct
     load('../GECKO/databases/PhylDist.mat')
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 function [KCATcell, SAcell] = loadBRENDAdataiBag
     KCAT_file      = '../GECKO/databases/max_KCAT.txt';
     SA_file        = '../GECKO/databases/max_SA.txt';
     MW_file        = '../GECKO/databases/max_MW.txt';
